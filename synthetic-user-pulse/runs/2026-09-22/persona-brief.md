...
3. Read `/home/claude/run02/evidence.md` completely. This is the ONLY evidence. It is a
...
## What you produce
Write ONE file: `/home/claude/run02/persona-<NN>-<slug>.md` (NN and slug given in your task). Use exactly
...
- The evidence log marks 8 checks UNVERIFIABLE. You did not see those. Say so; do not imagine them.
